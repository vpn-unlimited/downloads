(function (root) {
  ...
  const navigation = [
    ...
    },
    {
      ...
      items: [
        ...
        { externalPath: "https://www.vpnunlimited.com/downloads/windows-phone", label: "Windows Phone", icon: "windows" },
      ],
    },
    {
      title: "Browsers",
  ...
  const pages = {
    ...
    macos: {
      ...
      image: "mac-os-downloads_18920.webp",
    ...
    ios: {
      ...
      image: "ios-downloads_16399.webp",
    ...
    chrome: {
      ...
      image: "chrome-downloads_16402.webp",
